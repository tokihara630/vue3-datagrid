...
export const vueColumnTemplateConstructor =
...
const vueColumnTemplate = (vueConstructor: any) => {
    const current = getCurrentInstance();
    const appContext = current?.appContext;
    return (h: RevoGrid.HyperFunc<VNode>, p: RevoGrid.ColumnRegular) => <span ref={(el) => vueColumnTemplateConstructor(vueConstructor, el as HTMLElement, p, appContext)}></span>;
};

export default vueColumnTemplate;
