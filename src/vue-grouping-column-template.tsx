...
export const vueGroupingColumnTemplateConstructor =
...
const vueGroupingColumnTemplate = (vueConstructor: any) => {
    const current = getCurrentInstance();
    const appContext = current?.appContext;
    return (h: RevoGrid.HyperFunc<VNode>, p: RevoGrid.ColumnGrouping) => <span ref={(el) => vueGroupingColumnTemplateConstructor(vueConstructor, el as HTMLElement, p, appContext)}></span>;
};

export default vueGroupingColumnTemplate;
